...
const { githubClient } = __nccwpck_require__(915)
const { logInfo, logWarning, logError } = __nccwpck_require__(739)
const {
  MERGE_STATUS,
  MERGE_STATUS_KEY,
  getInputs,
...
const { updateTypes } = __nccwpck_require__(589)
const { updateTypesPriority } = __nccwpck_require__(589)
...
const run = __nccwpck_require__(891)
...
const { mapUpdateType } = __nccwpck_require__(589)
const { logWarning } = __nccwpck_require__(739)
...
"use strict";
module.exports = JSON.parse('{"name":"github-action-merge-dependabot","version":"3.10.2","description":"A GitHub action to automatically merge and approve Dependabot pull requests","main":"src/index.js","type":"commonjs","scripts":{"build":"ncc build src/index.js","lint":"eslint .","lint:fix":"eslint . --fix","test":"tap","prepare":"husky install"},"author":{"name":"Salman Mitha","email":"SalmanMitha@gmail.com"},"contributors":["Simone Busoli <simone.busoli@nearform.com>"],"license":"MIT","repository":{"type":"git","url":"git+https://github.com/fastify/github-action-merge-dependabot.git"},"bugs":{"url":"https://github.com/fastify/github-action-merge-dependabot/issues"},"homepage":"https://github.com/fastify/github-action-merge-dependabot#readme","dependencies":{"@actions/core":"^1.10.1","actions-toolkit":"github:nearform/actions-toolkit"},"devDependencies":{"@vercel/ncc":"^0.38.1","eslint":"^8.57.0","eslint-config-prettier":"^9.1.0","eslint-plugin-prettier":"^5.2.1","husky":"^9.1.6","prettier":"^3.3.3","proxyquire":"^2.1.3","sinon":"^19.0.2","tap":"^21.0.1"}}');
